...
public class DefaultGTMRefreshHeader: GTMRefreshHeader, SubGTMRefreshHeaderProtocol {
    ...
    var pullDownToRefresh = GTMRLocalize("下拉即可刷新...")
    var releaseToRefresh = GTMRLocalize("放手开始刷新...")
    var refreshSuccess = GTMRLocalize("刷新成功！")
    var refreshFailure = GTMRLocalize("刷新失败！")
    var refreshing = GTMRLocalize("刷新中...")
